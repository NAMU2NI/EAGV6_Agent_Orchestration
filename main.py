...
# long-context OpenAI/Gemini; HUGE is rejected (Summarizer Agent will live in V7).
TIER_TO_ORDER = {
    "TINY":  ["github", "openrouter", "groq", "nvidia", "cerebras", "openai", "gemini", "ollama"],
            ...
            raise HTTPException(
                503,
                {
                    ...
                    "hint": "Use the Summarizer Agent (V7, not yet implemented). "
                            "For now, chunk the input or set provider=openai explicitly to try GPT anyway.",
